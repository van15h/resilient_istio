...
echo "deleting js env variable for cpanel v1: src/cpanel_v1/static/scripts/url_env.js"
rm -rf src/cpanel_v1/static/scripts/url_env.js

echo "deleting js env variable for cpanel v2: src/cpanel_v2/static/scripts/url_env.js"
